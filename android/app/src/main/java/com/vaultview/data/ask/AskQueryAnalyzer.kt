 ...
 * Full natural-language questions stay for Nano; only extracted terms hit VaultPeep search.
 */
...
data class AnalyzedQuery(
    ...
    /** Terms actually sent to VaultPeep search (subjects + rare fallbacks + variants). */
