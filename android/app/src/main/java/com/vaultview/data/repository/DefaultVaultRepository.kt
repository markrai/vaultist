...
import com.vaultview.data.api.ApiPayload
import com.vaultview.data.api.VaultViewApi
import com.vaultview.data.api.normalizeServerUrl
import com.vaultview.data.api.parseApiError
import com.vaultview.data.api.toBacklinks
import com.vaultview.data.api.toBrowsePage
import com.vaultview.data.api.toIndexState
import com.vaultview.data.api.toNote
...
class DefaultVaultRepository @Inject constructor(
    ...
    private suspend fun <T> result(block: suspend () -> T): VaultResult<T> = try {
        ...
        VaultResult.Failure(VaultError.InvalidResponse("The server response was not valid Vault Peep JSON"))
    }
}
